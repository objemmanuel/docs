...
_**Note**_: _The `allowHighFee == true` might be dangerous to use, Please make sure you know what you are doing, Please test on the `testnet` before you do anything on `mainnet`, otherwise you might take the risk of losing your asset. Read more about the concept of transaction fee from_ [_the bitcoin book_](https://github.com/bitcoinbook/bitcoinbook/blob/develop/ch06.asciidoc#adding-fees-to-transactions)
